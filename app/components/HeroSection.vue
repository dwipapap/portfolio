...
<template>
    <section
        id="home"
        class="min-h-[85vh] flex items-center pt-24 pb-16"
    >
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-24">
            <div class="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
                ...
                >
                    <UButton
                        ...
                        variant="solid"
                        size="lg"
                        class="px-6 rounded-full shadow-sm"
                        download
                    >
                        Download CV
                    </UButton>
