  ...
  <section id="experience" class="py-16">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative space-y-8 pl-8 sm:pl-0">
        ...
        <div class="absolute left-3 top-0 bottom-0 w-0.5 bg-gray-200 dark:bg-gray-700 sm:left-4" />
        ...
        >
          <!-- Timeline Dot -->
          <div class="absolute left-1.5 top-2 h-3 w-3 sm:left-2.5 rounded-full bg-primary-500 border-2 border-white dark:border-gray-900 ring-2 ring-gray-100 dark:ring-gray-800" />
          ...
          <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
            ...
            <div class="mt-1 sm:mt-0 text-sm font-medium text-primary-600 dark:text-primary-400">
              {{ job.dateRange }}
            </div>
          </div>

          <ul class="list-disc list-outside ml-4 space-y-1 text-gray-600 dark:text-gray-400">
