      ...
      <div v-if="isMounted">
        <UPopover arrow :content="{ side: 'top', align: 'end', sideOffset: 12 }">
          <template #default="{ open }">
            <button v-if="!imageError" type="button"
              ...
              <div class="w-full h-full flex items-center justify-center"
                :class="[open ? '' : 'animate-subtle-bounce']">
                <img :src="imageSrc" alt="Floating Action Menu"
            ...
            <UButton v-else icon="i-heroicons-plus" size="xl" color="primary" variant="solid"
            ...
            <div class="p-3 w-64 sm:w-72">
              <div class="space-y-3">
                ...
                <div class="flex flex-col gap-0.5">
                  <button v-for="widget in widgets" :key="widget.label"
